...
public class MainUI extends Application {
    ...
    private void initDownloadButton(){
        mainAnchorPane.getChildren().add(bottomright(downloadFile, 35, 0));
        mainAnchorPane.getChildren().add(bottomright(downloadUrl, 35, 100));
    }

    private void initShareButton(){
        mainAnchorPane.getChildren().add(bottomright(addFile, 0, 0));
    }
